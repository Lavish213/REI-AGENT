...
SEQUENCES: dict[str, list[tuple[int, str]]] = {
    "seller": [
        ...
        (3, "Hey {first_name} \u2014 Sophia again. I'm assuming you've probably already figured out what you're doing with {address}. Am I right? If not just reply back."),
        (7, "Hi {first_name} \u2014 most people I talk to in Stockton are either dealing with a life change or a property situation. Just out of curiosity \u2014 is that kind of what's going on with {address}? - Sophia"),
        (14, "Hey {first_name} \u2014 I had someone asking about properties on your street last week. Just curious \u2014 have you ever thought about what you could get for {address}? - Sophia SJ House Buyers"),
        (21, "{first_name} — I'm guessing at this point you've probably already moved on. Am I right? If not just reply back. - Sophia"),
        (30, "Hey {first_name} \u2014 Sophia one more time. Timing probably just hasn't been right for {address}. If that changes just text me. - Sophia"),
        (45, "Hey {first_name}, Sophia here. It's been a while \u2014 still thinking about {address} at all? Just checking in."),
    ...
    "pre_foreclosure": [
        (0, "Hey {first_name} \u2014 I'm guessing you probably already have a plan for {address}. Am I right? - Sophia, SJ House Buyers. Reply STOP to opt out."),
        (1, "{first_name} \u2014 I'm assuming you've probably already talked to the bank about options. Am I right? We've helped others in similar situations. - Sophia"),
        (3, "Hey {first_name} \u2014 most people I talk to in this situation just want to know their options before the window closes. Is that kind of where you're at? Just out of curiosity. - Sophia"),
        (5, "{first_name} \u2014 last one from me. I'm guessing the timing just isn't right. If that changes just reply back. - Sophia SJ House Buyers"),
    ],
    "tax_delinquent": [
        (0, "Hey {first_name} \u2014 I'm guessing you've probably already got a plan for {address}. Am I right? - Sophia, SJ House Buyers"),
        (3, "Hey {first_name} \u2014 most people I talk to in your situation just want to know it can be resolved without coming out of pocket. Is that kind of where you're at? Just curious. - Sophia"),
        (7, "{first_name} \u2014 I'm assuming at this point you've probably moved on. If {address} is still on your mind just reply back. - Sophia"),
    ],
    "absentee_owner": [
        (0, "Hey \u2014 I'm guessing {address} is probably just fine and you're not thinking about selling. Am I right? - Sophia, SJ House Buyers"),
        (5, "Hey {first_name} \u2014 I'm assuming managing {address} from a distance is probably not a problem. Am I right? If it is just reply back. - Sophia"),
        (14, "{first_name} \u2014 I'm guessing at this point you've probably figured out what you're doing with {address}. If not just text back. - Sophia SJ House Buyers"),
    ],
    "divorce_probate": [
        (0, "Hey {first_name} \u2014 I'm guessing you probably already have someone helping you with {address}. Am I right? - Sophia, SJ House Buyers"),
        ...
        (14, "{first_name} \u2014 I'm assuming the timing just isn't right. Whenever it is we're here. No pressure. - Sophia"),
    ],
    "vacancy": [
        (0, "Hey \u2014 I'm guessing {address} is probably not something you're looking to sell right now. Am I right? - Sophia, SJ House Buyers"),
        (3, "{first_name} \u2014 I'm assuming you've probably already got plans for {address}. Am I right? If not just reply back. - Sophia"),
    ],
    "buyer": [
