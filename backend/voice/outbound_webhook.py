...
async def handle_outbound_status(
    ...
    try:
        ...
        if call_status in _TERMINAL_STATUSES:
            ...
            if call_status == "completed" and duration < 90 and answered_by_status not in ("human", "human-residence", "human-business"):
...
async def outbound_voice_stream(
    ...
    try:
        ...
        call_number = int((lead or {}).get("call_count") or (lead or {}).get("call_number") or 1)
